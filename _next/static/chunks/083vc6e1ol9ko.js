...
그 결과 MLE가 가지는 문제점을 완화하는 효과를 준다.`,{headingReplacements:{"MLE-$\\mu$":"MLE - 평균 μ","MLE-$\\sigma$":"MLE - 표준편차 σ"}}),[...u];let y=["ISLR","정보이론","OpenRouteService","Python"],k=[{value:"all",label:"전체"},{value:"projects",label:"프로젝트"},{value:"papers",label:"논문"},{value:"learning",label:"학습"}];a.s(["ArchiveSearchPage",0,function({documents:a}){let[p,s]=(0,r.useState)(""),[m,g]=(0,r.useState)("all"),l=(0,r.useDeferredValue)(p),$=(0,r.useRef)(null),c=(0,r.useMemo)(()=>{let t=function(a,t){let e=w(t);if(!e)return a;let r=e.split(" ");return a.flatMap(a=>{if(!r.every(t=>a.searchableText.includes(t)))return[];let t=w(a.title),i=w(a.tags.join(" ")),n=0;return t===e&&(n+=20),t.startsWith(e)&&(n+=10),t.includes(e)&&(n+=6),i.includes(e)&&(n+=4),[{document:a,score:n}]}).toSorted((a,t)=>t.score-a.score||t.document.updatedAt.localeCompare(a.document.updatedAt)).map(({document:a})=>a)}(a,l);return"all"===m?t:t.filter(a=>a.section===m)},[l,a,m]);return(0,r.useEffect)(()=>{let a=new URLSearchParams(window.location.search),t=a.get("q"),e=a.get("section"),r=window.setTimeout(()=>{t&&s(t),e&&k.some(a=>a.value===e)&&g(e)},0),i=a=>{let t=a.target,e=t?.matches("input, textarea, select, [contenteditable='true']");"/"!==a.key||e||(a.preventDefault(),$.current?.focus()),"Escape"===a.key&&document.activeElement===$.current&&(s(""),$.current?.blur())};return window.addEventListener("keydown",i),()=>{window.clearTimeout(r),window.removeEventListener("keydown",i)}},[]),(0,r.useEffect)(()=>{let a=new URL(window.location.href);p.trim()?a.searchParams.set("q",p.trim()):a.searchParams.delete("q"),"all"===m?a.searchParams.delete("section"):a.searchParams.set("section",m),window.history.replaceState({},"",`${a.pathname}${a.search}${a.hash}`)},[p,m]),(0,t.jsxs)("div",{className:"archive-search-explorer",children:[(0,t.jsxs)("form",{className:"archive-search-form",role:"search",onSubmit:a=>a.preventDefault(),children:[(0,t.jsx)(n.Search,{"aria-hidden":"true"}),(0,t.jsx)("label",{className:"archive-sr-only",htmlFor:"archive-search-input",children:"전체 기록 검색"}),(0,t.jsx)("input",{id:"archive-search-input",onChange:a=>s(a.target.value),placeholder:"제목 · 분야 · 키워드 · 도구",ref:$,type:"search",value:p}),p?(0,t.jsx)("button",{"aria-label":"검색어 지우기",onClick:()=>s(""),type:"button",children:(0,t.jsx)(o.X,{"aria-hidden":"true"})}):(0,t.jsx)("kbd",{"aria-hidden":"true",children:"/"})]}),(0,t.jsxs)("div",{className:"archive-search-suggestions","aria-label":"추천 검색어",children:[(0,t.jsx)("span",{children:"추천"}),y.map(a=>(0,t.jsx)("button",{onClick:()=>s(a),type:"button",children:a},a))]}),(0,t.jsxs)("div",{className:"archive-search-filters","aria-label":"검색 분야",children:[(0,t.jsx)("span",{children:"분야"}),(0,t.jsx)("div",{children:k.map(a=>(0,t.jsx)("button",{"aria-pressed":m===a.value,onClick:()=>g(a.value),type:"button",children:a.label},a.value))})]}),(0,t.jsxs)("div",{className:"archive-search-status","aria-live":"polite","aria-atomic":"true",children:[(0,t.jsxs)("strong",{children:["기록(",c.length,")"]}),(0,t.jsx)("span",{children:l?`“${l}”`:"전체"})]}),c.length?(0,t.jsx)("ol",{className:"archive-search-results","aria-label":"검색 결과",children:c.map(a=>(0,t.jsx)("li",{children:(0,t.jsxs)(e.default,{href:`/notes/${a.slug}`,children:[(0,t.jsxs)("span",{className:"archive-search-result-meta",children:[(0,t.jsx)("i",{children:a.category}),(0,t.jsx)("time",{dateTime:a.updatedAt,children:function(a){let[t,e,r]=a.split("-");return`${t}.${e}.${r}`}(a.updatedAt)})]}),(0,t.jsx)("strong",{children:a.title}),(0,t.jsx)("span",{className:"archive-search-result-summary",children:a.summary}),a.tags.length?(0,t.jsx)("span",{className:"archive-search-result-tags","aria-label":"키워드와 도구",children:a.tags.slice(0,4).map(a=>(0,t.jsx)("i",{children:a},a))}):null,(0,t.jsx)(i.ArrowUpRight,{"aria-hidden":"true"})]})},a.slug))}):(0,t.jsxs)("div",{className:"archive-search-empty",role:"status",children:[(0,t.jsx)("strong",{children:"검색 결과 없음"}),(0,t.jsx)("button",{onClick:()=>{s(""),g("all")},type:"button",children:"초기화"})]})]})}],92177)}]);