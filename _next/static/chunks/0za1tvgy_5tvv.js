...
여기서 $\alpha$는 prior의 precision이고, $\beta$는 noise의 precision이다. 따라서 $L_2$ regularization은 Bayesian 관점에서 Gaussian prior를 둔 MAP estimation으로 해석할 수 있다.`,{headingReplacements:{"polynomial curve fitting":"Polynomial Curve Fitting","1-D / Multivariate Gaussian distribution":"1차원·다변량 Gaussian 분포"}}),w(String.raw`# Binary Classification
...
| $dZ^{[1]}$        |    $64\times256$ |
| $dW^{[1]}$        |  $64\times49152$ |
| $db^{[1]}$        |      $64\times1$ |`,{headingReplacements:{"layer가 여러 개 일 때,":"여러 레이어일 때","LAYER 1(64 Nodes)":"Layer 1(64 Nodes)","LAYER 2(8 Nodes)":"Layer 2(8 Nodes)","LAYER 3(1 Node)":"Layer 3(1 Node)"}}),w(String.raw`## Train/dev/test sets
1) 데이터가 적은 경우
- 70/30% 또는 60/20/20%
...
입력 $x$만 정규화하는 것이 아니라 layer마다 새로 계산되는 $Z$를 mini-batch 기준으로 정규화한다.`,{headingReplacements:{}}),w(String.raw`다음은 K-means Clustering의 수식적인 설명과 Maximum Likelihood의 관계(가우시안 포함)를 MLE의 한계를 다룬다.
...
(MLE: cluster를 늘려 Loss를 줄이려고 하지만, 이는 noise까지 학습한 overfitting 상태가 됨)`,{headingReplacements:{"estimate $\\mu_k$":"μₖ 추정"}}),w(String.raw`다음은 1-D Gaussian 분포에 대한 MLE와 Bayesian 접근법의 차이에 대한 내용이다.
...
그 결과 MLE가 가지는 문제점을 완화하는 효과를 준다.`,{headingReplacements:{"MLE-$\\mu$":"MLE - 평균 μ","MLE-$\\sigma$":"MLE - 표준편차 σ"}});let y=new Set(["Basic CNN"]);function k(a){return a.normalize("NFKC").toLocaleLowerCase("ko-KR").trim().replace(/\s+/g," ")}[...b.filter(a=>!y.has(a.title))];let N=["ISLR","정보이론","OpenRouteService","Python"],v=[{value:"all",label:"전체"},{value:"projects",label:"프로젝트"},{value:"papers",label:"논문"},{value:"learning",label:"학습"}];a.s(["ArchiveSearchPage",0,function({documents:a}){let[p,s]=(0,r.useState)(""),[m,l]=(0,r.useState)("all"),g=(0,r.useDeferredValue)(p),c=(0,r.useRef)(null),$=(0,r.useMemo)(()=>{let t=function(a,t){let e=k(t);if(!e)return a;let r=e.split(" ");return a.flatMap(a=>{if(!r.every(t=>a.searchableText.includes(t)))return[];let t=k(a.title),i=k(a.tags.join(" ")),n=0;return t===e&&(n+=20),t.startsWith(e)&&(n+=10),t.includes(e)&&(n+=6),i.includes(e)&&(n+=4),[{document:a,score:n}]}).toSorted((a,t)=>t.score-a.score||t.document.updatedAt.localeCompare(a.document.updatedAt)).map(({document:a})=>a)}(a,g);return"all"===m?t:t.filter(a=>a.section===m)},[g,a,m]);return(0,r.useEffect)(()=>{let a=new URLSearchParams(window.location.search),t=a.get("q"),e=a.get("section"),r=window.setTimeout(()=>{t&&s(t),e&&v.some(a=>a.value===e)&&l(e)},0),i=a=>{let t=a.target,e=t?.matches("input, textarea, select, [contenteditable='true']");"/"!==a.key||e||(a.preventDefault(),c.current?.focus()),"Escape"===a.key&&document.activeElement===c.current&&(s(""),c.current?.blur())};return window.addEventListener("keydown",i),()=>{window.clearTimeout(r),window.removeEventListener("keydown",i)}},[]),(0,r.useEffect)(()=>{let a=new URL(window.location.href);p.trim()?a.searchParams.set("q",p.trim()):a.searchParams.delete("q"),"all"===m?a.searchParams.delete("section"):a.searchParams.set("section",m),window.history.replaceState({},"",`${a.pathname}${a.search}${a.hash}`)},[p,m]),(0,t.jsxs)("div",{className:"archive-search-explorer",children:[(0,t.jsxs)("form",{className:"archive-search-form",role:"search",onSubmit:a=>a.preventDefault(),children:[(0,t.jsx)(n.Search,{"aria-hidden":"true"}),(0,t.jsx)("label",{className:"archive-sr-only",htmlFor:"archive-search-input",children:"전체 기록 검색"}),(0,t.jsx)("input",{id:"archive-search-input",onChange:a=>s(a.target.value),placeholder:"제목 · 분야 · 키워드 · 도구",ref:c,type:"search",value:p}),p?(0,t.jsx)("button",{"aria-label":"검색어 지우기",onClick:()=>s(""),type:"button",children:(0,t.jsx)(o.X,{"aria-hidden":"true"})}):(0,t.jsx)("kbd",{"aria-hidden":"true",children:"/"})]}),(0,t.jsxs)("div",{className:"archive-search-suggestions","aria-label":"추천 검색어",children:[(0,t.jsx)("span",{children:"추천"}),N.map(a=>(0,t.jsx)("button",{onClick:()=>s(a),type:"button",children:a},a))]}),(0,t.jsxs)("div",{className:"archive-search-filters","aria-label":"검색 분야",children:[(0,t.jsx)("span",{children:"분야"}),(0,t.jsx)("div",{children:v.map(a=>(0,t.jsx)("button",{"aria-pressed":m===a.value,onClick:()=>l(a.value),type:"button",children:a.label},a.value))})]}),(0,t.jsxs)("div",{className:"archive-search-status","aria-live":"polite","aria-atomic":"true",children:[(0,t.jsxs)("strong",{children:["기록(",$.length,")"]}),(0,t.jsx)("span",{children:g?`“${g}”`:"전체"})]}),$.length?(0,t.jsx)("ol",{className:"archive-search-results","aria-label":"검색 결과",children:$.map(a=>(0,t.jsx)("li",{children:(0,t.jsxs)(e.default,{href:`/notes/${a.slug}`,children:[(0,t.jsxs)("span",{className:"archive-search-result-meta",children:[(0,t.jsx)("i",{children:a.category}),(0,t.jsx)("time",{dateTime:a.updatedAt,children:function(a){let[t,e,r]=a.split("-");return`${t}.${e}.${r}`}(a.updatedAt)})]}),(0,t.jsx)("strong",{children:a.title}),(0,t.jsx)("span",{className:"archive-search-result-summary",children:a.summary}),a.tags.length?(0,t.jsx)("span",{className:"archive-search-result-tags","aria-label":"키워드와 도구",children:a.tags.slice(0,4).map(a=>(0,t.jsx)("i",{children:a},a))}):null,(0,t.jsx)(i.ArrowUpRight,{"aria-hidden":"true"})]})},a.slug))}):(0,t.jsxs)("div",{className:"archive-search-empty",role:"status",children:[(0,t.jsx)("strong",{children:"검색 결과 없음"}),(0,t.jsx)("button",{onClick:()=>{s(""),l("all")},type:"button",children:"초기화"})]})]})}],92177)}]);